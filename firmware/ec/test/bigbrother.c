...
{
	//## Changed 07/05 to false
    if (OcGpio_write(&pin_uart_sel, false) < OCGPIO_SUCCESS) {
        return RETURN_NOTOK;
    }
    return RETURN_OK;
}
...
#if 0
    OcGpio_Pin OCT_SYS_PLL_PMUL0   = { &gbc_io_1, 0, OCGPIO_CFG_OUT_OD_NOPULL };
    OcGpio_Pin OCT_SYS_PLL_PMUL1   = { &gbc_io_1, 1, OCGPIO_CFG_OUT_OD_NOPULL };
    OcGpio_Pin OCT_SYS_PLL_PMUL2   = { &gbc_io_1, 2, OCGPIO_CFG_OUT_OD_NOPULL };
    OcGpio_Pin OCT_SYS_PLL_PMUL3   = { &gbc_io_1, 3, OCGPIO_CFG_OUT_OD_NOPULL };
    OcGpio_Pin OCT_SYS_PLL_PMUL4   = { &gbc_io_1, 4, OCGPIO_CFG_OUT_OD_NOPULL };
    OcGpio_Pin OCT_PLL_MUL0   =     { &gbc_io_1, 5, OCGPIO_CFG_OUT_OD_NOPULL };
    OcGpio_Pin OCT_PLL_MUL1   =     { &gbc_io_1, 6, OCGPIO_CFG_OUT_OD_NOPULL };
    OcGpio_Pin OCT_PLL_MUL2   =     { &gbc_io_1, 7, OCGPIO_CFG_OUT_OD_NOPULL };
    OcGpio_Pin OCT_PLL_MUL3   =     { &gbc_io_1, 8, OCGPIO_CFG_OUT_OD_NOPULL };
    OcGpio_Pin OCT_PLL_MUL4   =     { &gbc_io_1, 9, OCGPIO_CFG_OUT_OD_NOPULL };
    OcGpio_Pin OCT_PLL_MUL5   =     { &gbc_io_1, 10, OCGPIO_CFG_OUT_OD_NOPULL };
    OcGpio_Pin BOOT_METHOD_GPIO_0   = { &gbc_io_1, 11, OCGPIO_CFG_OUT_OD_NOPULL };
    OcGpio_Pin BOOT_METHOD_GPIO_1   = { &gbc_io_1, 12, OCGPIO_CFG_OUT_OD_NOPULL };
    OcGpio_Pin BOOT_METHOD_GPIO_2   = { &gbc_io_1, 13, OCGPIO_CFG_OUT_OD_NOPULL };
    OcGpio_Pin BOOT_METHOD_GPIO_3   = { &gbc_io_1, 14, OCGPIO_CFG_OUT_OD_NOPULL };
    OcGpio_Pin TRXFE_PWR_ALRT   = { &gbc_io_1, 15, OCGPIO_CFG_IN_NOPULL };
#endif
    /*Configuration*/
