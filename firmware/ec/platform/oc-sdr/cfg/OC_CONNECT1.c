...
GPIO_PinConfig gpioPinConfigs[OC_EC_GPIOCOUNT] = {
    ...
    [OC_EC_LIGHT_SENSE_INT] =
        GPIOTiva_PD_3 | GPIO_CFG_IN_PU | GPIO_CFG_IN_INT_FALLING, /*pin changed for GBCv2*/
    [OC_EC_TPM_INT_REQ] =
        GPIOTiva_PD_6 | GPIO_CFG_IN_PU | GPIO_CFG_IN_INT_FALLING ,
