...
SOFTWARE_VERSION = 'BB-RevC-FE-RevE-v2.1'
ROOT_FOLDER = 'pyscripts'
#MAC_ADDR = '00-D0-CC-20-14-2E'
MAC_ADDR = '00-D0-CC-20-14-06'
...
if __name__ == '__main__':
    ...
    with utils.stack_chdir(ROOT_FOLDER):
        ...
        # this does the tftp.txt
        #env_file_path = context.UBOOT_FINALFILEENV
        #context.server.env_var.setup_from_file(env_file_path)
        #context.server.env_var.clear_all_and_setup_from_files(context.UBOOT_SETUPFILEENV, context.UBOOT_FINALFILEENV)
