<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="accsrvrq.aspx.cs" Inherits="cnip.pages.accsrvrq" %>
...
<body>
    <nav class="navbar navbar-default">
        <div class="container-fluid">
            ...
            <div class="nav navbar-nav navbar-right">
                <a href="https://github.com/alirazaanis/Community-Network-Interactive-Planner/blob/master/README.md#user-guide" id="userGuide" class="btn btn-primary" target="_blank"><i class="fas fa-book"></i>&nbsp;User Guide</a>
            </div>
        </div>
    </nav>
        ...
        <div class="d-flex justify-content-center h-100">
            <div class="card">
                ...
                <div class="card-footer">
                    <a id="btnlnk" href="#">
                        <input id="btn" type="button" value="" class="btn float-right login_btn" hidden="hidden" />
                    </a>
    ...
    <script src="../Scripts/cnip/acc/accsrvrq.js"></script>
</body>
</html>