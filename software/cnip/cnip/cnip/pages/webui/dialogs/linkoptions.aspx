                ...
                <td style="width: 48%;">Site A                   
                    ...
                    <table>
                        <tr>
                            ...
                            <td style="width: 60%;">
                                <input id="siteheighta" type="text" readonly="readonly" disabled="disabled" class="textInput" />
                            </td>
                        </tr>
                    </table>
                    <table>
                    ...
                    <table>
                        <tr>
                            <td style="width: 40%;">
                                <span>Device Height (m)</span>
                            </td>
                            <td style="width: 60%;">
                                <input id="heighta" type="text" class="textInput" />
                            </td>
                        </tr>
                    </table>
                    <table>
                ...
                <td style="width: 48%;">
                    ...
                    <table>
                        <tr>
                            ...
                            <td style="width: 60%;">
                                <input id="siteheightb" type="text" readonly="readonly" disabled="disabled" class="textInput" />
                            </td>
                        </tr>
                    </table>
                    <table>
                    ...
                    <table>
                        <tr>
                            ...
                            <td style="width: 60%;">
                                <input id="heightb" type="text" class="textInput" />
                            </td>
                        </tr>
                    </table>
                    <table>
