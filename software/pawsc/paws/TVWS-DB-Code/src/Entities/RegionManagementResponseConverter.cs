...
namespace Microsoft.Whitespace.Entities
{
    ...
    /// </summary>
    internal class RegionManagementResponseConverter : BaseJsonConverter
    {
        /// <summary>
        ...
        {
            RegionManagementResponse location = existingValue as RegionManagementResponse ?? new RegionManagementResponse();
