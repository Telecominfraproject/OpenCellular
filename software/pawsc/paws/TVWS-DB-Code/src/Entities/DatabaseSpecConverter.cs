...
namespace Microsoft.Whitespace.Entities
{
    ...
    /// </summary>
    public class DatabaseSpecConverter : BaseJsonConverter
    {
        /// <summary>
        ...
        {
            DatabaseSpec databaseSpec = existingValue as DatabaseSpec ?? new DatabaseSpec();
            ...
            for (int i = 0; i < properties.Count; i++)
            {
                ...
                {
                    case Constants.PropertyNameName:
                        databaseSpec.Name = jsonProp.ToObject<string>();
                        break;

                    case Constants.PropertyNameUri:
                        databaseSpec.Uri = jsonProp.ToObject<string>();
                        break;
